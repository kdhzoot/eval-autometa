...
DEFAULT_INPUT = (SCRIPT_DIR / "log_traces" / "perf_parsed.csv").resolve()
DEFAULT_OUTPUT = (SCRIPT_DIR / "log_traces" / "perf_hit_level.csv").resolve()


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description=(
            "Aggregate index/filter access counts from perf_parsed.csv "
